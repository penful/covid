...
summary(M3Italy)[5]
summary(M4Italy)[5]
round(M3Italy$coefficients,3)
round(M4Italy$coefficients,3)
...
n<-dim(dataUmbria)[1]
m<-max(totItaly)
ytick<-c(200,27009,54018,81027,110000)
xtick<-c(1,50,100,133)
plot(totItaly, 
   line = 2.5,
...
plot(prevIT[1:133]*1000, 
     ylab= "Prevalenza dei casi attualmente positivi",  
     line = 2.5,
     col = "blue4",
     xlab=expression("Giorni ("*italic(t)*")"),
     yaxt="n",
